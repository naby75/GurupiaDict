...
- ✅ **[보안]** XML Bomb(Billion Laughs) 방어 (`resolve_entities=False`)
- ✅ **[성능]** Python 정규식 전역 캐싱 (GC 오버헤드/메모리 누수 방어)
- ✅ **[안정성]** 예외 은닉 방지 (`logging.exception()` 스택 트레이스 보존)
- ✅ **[성능]** 대용량 JSONL 스트리밍 저장 처리 (힙 누수 방어)
